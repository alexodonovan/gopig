...
/**
 * It get access to the ultrasonic sensor distance calculation. It also allows
...
public class UltraSonicSensor {
	...
	public UltraSonicSensor(Board board) throws IOException, InterruptedException {
		this.board = board;
	}
	 ...
	 * 
	 * @param pin
	 *            The number of the pin where the sensor is attached.
	 */

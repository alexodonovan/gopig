 ...
 * board. It also returns the status, the voltage and the firmware version of
 * the board.
 * 
 * @author marcello
 * 
...
public class Board {
	 ...
	 * 
	 * @param pin
	 *            The pin to use for the reading.
	 ...
	 * 
	 * @param pin
	 *            The ping to use for the writing.
	 * @param value
	 *            The value to write.
	 * @return A status code.
	 * @throws IOException
	...
	public int digitalWrite(int pin, int value) throws IOException {
		checkHalt();
		// if (pin == 10 || pin == 0 || pin == 1 || pin == 5 || pin == 16 || pin
		// == 17)
		if (value == 0 || value == 1) {
	 ...
	 * 
	 * @param pin
	 *            The ping to use for the reading.
	 ...
	 *            The ping to set.
	 * @param pinMode
	 *            The mode to set. 1 is OUTPUT, 0 is INPUT
	 * @return A status code.
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param msec
	 *            The value of the sleep in milliseconds.
	 */
